...
class _EditTransactionScreenState extends State<EditTransactionScreen> {
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      // Lấy transactionId từ transactionData
      ...
      // Cập nhật giao dịch, bao gồm cả title
      ...
      // Cập nhật tổng thu/chi của user
      final userDoc =
  ...
  Widget build(BuildContext context) {
    return Material(
      color: Colors.transparent, // Để nền trong suốt để dialog hiển thị bo góc
      child: ClipRRect(
        borderRadius: BorderRadius.circular(20), // Bo góc cho toàn bộ form
        child: Container(
          color: Colors.white, // Màu nền cho form
